...
class ChannelGroupPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, ChannelGroup $channelGroup)
    {
        return $user->isInSameCompany($channelGroup);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, ChannelGroup $channelGroup)
    {
        return $user->isInSameCompany($channelGroup);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, ChannelGroup $channelGroup)
    {
        return $user->isInSameCompany($channelGroup);
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, ChannelGroup $channelGroup)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, ChannelGroup $channelGroup)
    {
        //
    }
}
