    ...
    public function rules()
    {
        ...
        return [
            'name' => [
                ...
                'string',
                'max:255',
                Rule::unique('playlists')->where(function ($query) use ($authUser, $project, $playlist) {
                    /** @var \Illuminate\Database\Query\Builder $query */
                    return $query
                        ->where('playlist_group_id', $this->input('playlist_group_id', $playlist->playlist_group_id))
