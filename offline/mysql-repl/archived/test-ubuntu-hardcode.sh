...
docker run --name porta-db-1 --network=porta-net -e MYSQL_ROOT_PASSWORD=Porta123 -e MYSQL_ROOT_HOST=% -e MYSQL_DATABASE=porta \
        ...
        -p 192.168.50.163:3307:3307 -p 192.168.50.163:33061:33061 \
        ...
        --report-port='3307' \
        --plugin-load='clone=mysql_clone.so,group_replication=group_replication.so' \
...
#docker exec -i porta-db-1 mysql -h192.168.50.163 -P 3307 -uroot -pPorta123 -e "INSTALL PLUGIN group_replication SONAME 'group_replication.so';SHOW PLUGINS;"
