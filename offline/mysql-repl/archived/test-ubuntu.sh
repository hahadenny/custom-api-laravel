...
PRIMARY_MACHINE_IP="192.168.50.163"
...
for N in 1 2 3; do
    ...
    CREATE_CMD="docker create --name $CONTAINER_NAME --network=porta-net \
                    ...
                    -p $PRIMARY_MACHINE_IP:$NODE_PORT:$NODE_PORT -p $PRIMARY_MACHINE_IP:$NODE_REPL_PORT:$NODE_REPL_PORT \
                    mysql/mysql-server \
                    --character-set-server=utf8mb4 \
                    --collation-server=utf8mb4_unicode_ci \
                    --port=$NODE_PORT \
                    --report-host=$PRIMARY_MACHINE_IP \
    ...
    print_terminal_message "Creating and starting container for '$CONTAINER_NAME' on host '$PRIMARY_MACHINE_IP' port '$NODE_PORT' replication port: $NODE_REPL_PORT... \n \n \n MYSQL_ROOT_PASSWORD: Porta123 \n MYSQL_ROOT_HOST: % \n MYSQL_DATABASE: porta \n MYSQL_USER: porta \n MYSQL_PASSWORD: porta \n\n Volume: /tmp/porta-onprem/mysql-$N:/var/lib/mysql"
...
#        SHOW PLUGINS; "
    ...
    docker exec -i "$CONTAINER_NAME" mysql -uroot -pPorta123 -e \
        ...
        SET PERSIST group_replication_group_seeds='$PRIMARY_MACHINE_IP:$NODE_1_REPL_PORT,$PRIMARY_MACHINE_IP:$NODE_2_REPL_PORT,$PRIMARY_MACHINE_IP:$NODE_3_REPL_PORT'; \
        ...
        # SET PERSIST group_replication_ip_allowlist='$PRIMARY_MACHINE_IP,$BACKUP_MACHINE_IP,localhost,127.0.0.1,porta-db-1,porta-db-2,porta-db-3,porta-db-4'; \
        # SET PERSIST group_replication_group_seeds='$PRIMARY_MACHINE_IP:$NODE_1_REPL_PORT,$PRIMARY_MACHINE_IP:$NODE_2_REPL_PORT,$BACKUP_MACHINE_IP:$NODE_3_REPL_PORT,$BACKUP_MACHINE_IP:$NODE_4_REPL_PORT'; \
