...
docker run --name porta-db-2 --network=porta-net -e MYSQL_ROOT_PASSWORD=Porta123 -e MYSQL_ROOT_HOST=% -e MYSQL_DATABASE=porta \
        ...
        -p 10.17.2.8:3308:3308 -p 10.17.2.8:33062:33062 -d mysql/mysql-server \
        --character-set-server=utf8mb4 \
        --collation-server=utf8mb4_unicode_ci \
        --port='3308' \
        --report-host='10.17.2.8' \
        --report-port='3308' \
...
docker run --name porta-db-3 --network=porta-net -e MYSQL_ROOT_PASSWORD=Porta123 -e MYSQL_ROOT_HOST=% -e MYSQL_DATABASE=porta \
        ...
        -p 10.17.2.8:3309:3309 -p 10.17.2.8:33063:33063 -d mysql/mysql-server \
        --character-set-server=utf8mb4 \
        --collation-server=utf8mb4_unicode_ci \
        --port='3309' \
        --report-host='10.17.2.8' \
...
#        -p 10.17.2.8:3310:3310 -p 10.17.2.8:33064:33064 -d mysql/mysql-server \
#        --character-set-server=utf8mb4 \
#        --collation-server=utf8mb4_unicode_ci \
#        --port='3310' \
#        --report-host='10.17.2.8' \
