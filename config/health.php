...
return [
    ...
    'result_stores' => [
        ...
        */
        ...
        // Store in JSON file, mainly for ON-PREM install
        Spatie\Health\ResultStores\JsonFileHealthResultStore::class => [
            'disk' => 'local', // 's3',
            'path' => 'health.json',
        ],

        // Oh Dear App is keeping track of history so we don't need to store anything locally
    ...
    'notifications' => [
         ...
         *
         * NOTE: set to false if Oh Dear App is handling notifications
         */
        'enabled' => false,
